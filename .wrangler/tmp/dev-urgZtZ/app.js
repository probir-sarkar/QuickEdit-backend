...
// .wrangler/tmp/bundle-etYtWP/checked-fetch.js
  ...
  "node_modules/@prisma/client/runtime/index-browser.js"(exports, module) {
    ...
    var S = function() {
      ...
      return function(t, r, s, o, u, l) {
        var f, c, a, d, g, v, N, _, C, q, E, P, x, I, le, z2, G, ce, T, y, ee = t.constructor, ae = t.s == r.s ? 1 : -1, b = t.d, k = r.d;
        if (!b || !b[0] || !k || !k[0])
        ...
        if (k[a] > (b[a] || 0) && c--, s == null ? (I = s = ee.precision, o = ee.rounding) : u ? I = s + (t.e - r.e) + 1 : I = s, I < 0)
          ...
          if (I = I / g + 2 | 0, a = 0, T == 1) {
            ...
            for (d = l / (k[0] + 1) | 0, d > 1 && (k = e(k, d, l), b = e(b, d, l), T = k.length, G = b.length), z2 = T, E = b.slice(0, T), P = E.length; P < T; )
              E[P++] = 0;
            y = k.slice(), y.unshift(0), ce = k[0], k[1] >= l / 2 && ++ce;
            do
              d = 0, f = n(k, E, T, P), f < 0 ? (x = E[0], T != P && (x = x * l + (E[1] || 0)), d = x / ce | 0, d > 1 ? (d >= l && (d = l - 1), N = e(k, d, l), _ = N.length, P = E.length, f = n(N, E, _, P), f == 1 && (d--, i(N, T < _ ? y : k, _, l))) : (d == 0 && (f = d = 1), N = k.slice()), _ = N.length, _ < P && N.unshift(0), i(E, N, P, l), f == -1 && (P = E.length, f = n(k, E, T, P), f < 1 && (d++, i(E, T < P ? y : k, P, l))), P = E.length) : f === 0 && (d++, E = [0]), q[a++] = d, f && E[0] ? E[P++] = b[z2] || 0 : (E = [b[z2]], P = 1);
            while ((z2++ < G || E[0] !== void 0) && I--);
            v = E[0] !== void 0;
          }
          q[0] || q.shift();
        }
...
// .wrangler/tmp/bundle-etYtWP/middleware-loader.entry.ts
init_checked_fetch();
init_modules_watch_stub();

// .wrangler/tmp/bundle-etYtWP/middleware-insertion-facade.js
init_checked_fetch();
init_modules_watch_stub();
...
// src/controllers/contacts.ts
var getContacts = async (c) => {
  try {
    const contacts = await prisma_default.contact.findMany();
    c.json(contacts);
  } catch (error) {
    c.status(500);
...
var createContact = async (c) => {
  try {
    const { address, ...contactData } = createContactSchema.parse(c.body);
    const exisingContact = await prisma_default.contact.findUnique({
      where: {
        email_phone: {
    ...
    const contact = await prisma_default.contact.create({
      data: {
        ...contactData,
        address: {
          create: {
...
var deleteContact = async (c) => {
  try {
    ...
    const contact = await prisma_default.contact.delete({
      where: {
        id: parseInt(id)
      }
    });
...
var updateContactField = async (c) => {
  try {
    const id = c.req.param("id");
    if (!id || isNaN(parseInt(id))) {
      c.status(400);
    ...
    const contact = await prisma_default.contact.update({
      where: {
        id: parseInt(id)
      },
      data: {
...
var getContact = async (c) => {
  try {
    ...
    const contact = await prisma_default.contact.findUnique({
      where: {
        id: parseInt(id)
      },
      include: {
